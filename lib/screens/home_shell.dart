...
class _HomeShellState extends State<HomeShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      // No tab push routes onto the Navigator (IndexedStack just swaps
      // index), so without this the hardware/gesture back button has
      // nothing to pop on the Videos tab and Android exits the app.
      canPop: !onVideosTab,
