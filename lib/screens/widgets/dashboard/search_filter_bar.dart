...
/// Search field + genre chips + instrument chips + "solo libres" switch.
/// Every change here triggers a fresh, server-side filtered query — nothing
/// is filtered from a locally cached full list.
